...
export default function (s) {
  ...
  const waypointAnimate = $('.animate').waypoint(function (direction) {
  ...
  const waypointAnimateMultiple = $('.animate-multiple').waypoint(function (direction) {
  ...
  const waypointAnimateInView = $('.animate-in-view').waypoint(function (direction) {
    animateElement(this.element);
